...
import {
  ArrowLeft, GraduationCap, Users, Sparkles, MessageSquare, Brain,
        ...
        <div className="flex items-center justify-between px-8 py-4 max-w-6xl mx-auto">
          <div className="flex items-center gap-4">
            ...
            <Link href="/" className="flex items-center gap-2.5" style={{ textDecoration: "none" }}>
              ...
              <div>
                <div className="font-bold text-sm" style={{ color: "#0f172a" }}>Inquiry Engine</div>
                <div className="text-xs" style={{ color: "#94a3b8" }}>User Guide</div>
              </div>
            </Link>
          </div>
          <Link href="/chat" className="text-sm font-medium px-3 py-1.5 rounded-lg"
